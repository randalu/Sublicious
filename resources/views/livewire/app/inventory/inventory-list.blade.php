<div>
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">{{ $totalItems }} items &middot; Est. value: {{ number_format($totalValue, 2) }}
                @if($lowStockCount > 0)
                    &middot; <span class="text-red-600 font-medium">{{ $lowStockCount }} low stock</span>
                @endif
            </p>
        </div>
    ...
    @if($items->isEmpty())
        <div class="bg-white rounded-xl border border-dashed border-gray-300 p-12 text-center">
            ...
            <button wire:click="openForm()" class="mt-3 text-primary-600 text-sm font-medium hover:underline">Add your first item</button>
        </div>
    @else
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach($items as $item)
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-right text-sm font-medium {{ $isOut ? 'text-red-600' : ($isLow ? 'text-amber-600' : 'text-gray-900') }}">
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                @elseif($isLow)
                                    <span class="text-xs px-2 py-1 rounded-full bg-amber-100 text-amber-700">Low Stock</span>
                                @else
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <a href="{{ route('app.inventory.history', ['inventoryItem' => $item]) }}"
                                    ...
                                    <button wire:click="delete({{ $item->id }})"
                                            wire:confirm="Delete this inventory item and all its history?"
            ...
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
                ...
                <form wire:submit="save" class="space-y-4">
                    <div>
                        ...
                        <input wire:model="name" type="text" placeholder="e.g. Chicken Breast, Olive Oil"
            ...
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
                ...
                <form wire:submit="saveAdjustment" class="space-y-4">
                    <div>
                        ...
                        <select wire:model="adjustmentType" class="w-full rounded-lg border-gray-300 text-sm focus:border-primary-500 focus:ring-primary-500">
