...
Route::middleware(['auth', 'verified', 'business'])->prefix('app')->name('app.')->group(function () {
    ...
    // Inventory
    Route::get('/inventory', \App\Livewire\App\Inventory\ItemList::class)->name('inventory');
    Route::get('/inventory/transactions', \App\Livewire\App\Inventory\TransactionList::class)->name('inventory.transactions');
